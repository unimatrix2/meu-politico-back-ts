...
const tseSchema = new Schema({
    DT_GERACAO: { type: String },
    HH_GERACAO: { type: String },
    ANO_ELEICAO: { type: Number/* , index: true */ },
    ...
    NM_CANDIDATO: { type: String/* , index: true */ },
    NM_URNA_CANDIDATO: { type: String/* , index: true */ },
    NM_SOCIAL_CANDIDATO: { type: String/* , index: true */ },
    NR_CPF_CANDIDATO: { type: String/* , index: true */ },
    NM_EMAIL: { type: String/* , index: true */ },
...
const TSE = model('Candidatos', tseSchema);
module.exports = TSE;